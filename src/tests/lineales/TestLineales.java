...
public class TestLineales {
    ...
    public static void testColaEstatica() {
        System.out.println("***************COMIENZO TEST COLA ESTATICA*******************");
        lineales.estaticas.Cola q1 = new lineales.estaticas.Cola();
        ...
        while (num < 12) {
            if (num < 10) {
                ...
                System.out.print("Pone " + num + " espera false: \t\t\t\t\t" + ((q1.poner(num) == false) ? sOk : sErr));
            }
            num++;
            System.out.println("\t--> " + q1.toString());
        }
        System.out.println("Recupera frente espera 1 recupera " + q1.obtenerFrente() + ": \t\t\t" + (((int) q1.obtenerFrente() == 1) ? sOk : sErr));

        System.out.print("Saca espera true : \t\t\t\t\t" + ((q1.sacar() == true) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        System.out.println("Recupera frente espera 2 recupera " + q1.obtenerFrente() + "\t\t\t" + (((int) q1.obtenerFrente() == 2) ? sOk : sErr));
        System.out.print("Saca espera true: \t\t\t\t\t" + ((q1.sacar() == true) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        System.out.println("Recupera frente espera 3 recupera " + q1.obtenerFrente() + ": \t\t\t" + (((int) q1.obtenerFrente() == 3) ? sOk : sErr));
        ...
        lineales.estaticas.Cola q2 = q1.clone();
        System.out.println("Copia espera [3 4 5 6 7 8 9 23 24]: \t\t\t\t--> " + q2.toString());

        System.out.print("Pone 7 espera false: \t\t\t\t\t" + ((q1.poner(7) == false) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        System.out.print("Pone 8 espera false: \t\t\t\t\t" + ((q1.poner(8) == false) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        ...
        System.out.println("Recupera frente espera null, retorna " + q1.obtenerFrente() + ": \t\t" + ((q1.obtenerFrente() == null) ? sOk : sErr));

        System.out.println("Verifica copia guardada espera [3 4 5 6 7 8 9 23 24]: \t\t--> " + q2.toString());
        System.out.println("Pone 27 espera false: \t\t\t\t\t" + ((q2.poner(27) == false) ? sOk : sErr));
        System.out.println("Verifica copia espera [3 4 5 6 7 8 9 23 24]: \t\t\t--> " + q2.toString());
        System.out.println("Saca " + q2.obtenerFrente() + " de cola espera true: \t\t\t\t" + ((q2.sacar() == true) ? sOk : sErr));
        System.out.println("Verifica copia espera [4 5 6 7 8 9 23 24]: \t\t\t--> " + q2.toString());
        System.out.println("Saca " + q2.obtenerFrente() + " de cola espera true: \t\t\t\t" + ((q2.sacar() == true) ? sOk : sErr));
        System.out.println("Verifica copia espera [5 6 7 8 9 23 24]: \t\t\t--> " + q2.toString());
        System.out.println("Saca " + q2.obtenerFrente() + " de cola espera true:\t\t\t\t" + ((q2.sacar() == true) ? sOk : sErr));
        System.out.println("Verifica copia espera [6 7 8 9 23 24]: \t\t\t\t--> " + q2.toString());
        System.out.println("Pone 28: \t\t\t\t\t\t" + ((q2.poner(28) == true) ? sOk : sErr));
        System.out.println("Pone 29: \t\t\t\t\t\t" + ((q2.poner(29) == true) ? sOk : sErr));
        System.out.println("Verifica copia espera [6 7 8 9 23 24 28 29]: \t\t\t--> " + q2.toString());
        q2.vaciar();
        System.out.println("Vacia copia espera []: \t\t\t\t\t\t--> " + q2.toString());

    }

    public static void testColaDinamica() {
        System.out.println("***************COMIENZO TEST COLA DINAMICA*******************");
        lineales.dinamicas.Cola q1 = new lineales.dinamicas.Cola();
        System.out.println("Cola vacía: \t\t\t\t\t\t\t--> " + q1.toString());
        boolean exito = true;
        ...
        lineales.dinamicas.Cola q2 = q1.clone();
        System.out.println("Copia espera [3 4 5 6 7 8 9 10 11 23 24]: \t\t\t--> " + q2.toString());

        System.out.print("Pone 7 espera true: \t\t\t\t\t" + ((q1.poner(7) == true) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        System.out.print("Pone 8 espera true: \t\t\t\t\t" + ((q1.poner(8) == true) ? sOk : sErr));
        System.out.println("\t--> " + q1.toString());
        ...
        System.out.println("\t\t\t\t\t\t--> " + q1.toString());
        System.out.println("Sacar en cola vacia espera false: \t\t\t" + ((q1.sacar() == false) ? sOk : sErr));
        System.out.println("Recupera frente espera null, obtiene " + q1.obtenerFrente() + ": \t\t" + ((q1.obtenerFrente() == null) ? sOk : sErr));

        System.out.println("Verifica copia guardada espera [3 4 5 6 7 8 9 10 11 23 24]: \t--> " + q2.toString());
        System.out.println("Pone 27 espera true: \t\t\t\t\t" + ((q2.poner(27) == true) ? sOk : sErr));
    ...
    public static void testPilaEstatica() {

        System.out.println("***************COMIENZO TEST PILA ESTATICA*******************");
        lineales.estaticas.Pila p1 = new lineales.estaticas.Pila();
        System.out.println("\t\t\t\t\t\t\t\t--> " + p1.toString());

         for (int i = 1; i <= 10; i++) {
            System.out.print("Apila " + i + ":\t\t\t\t\t\t" + ((p1.apilar(i) == true) ? sOk : sErr));
            System.out.println("\t--> " + p1.toString());
        }
        
        System.out.println("Apila 11 espera false\t\t\t\t\t" + ((p1.apilar(11) == false) ? sOk : sErr));
        ...
        lineales.estaticas.Pila p2 = p1.clone();
        ...
        System.out.println("Apila 8 espera false:\t\t\t\t\t" + ((p2.apilar(8) == false) ? sOk : sErr));
        System.out.println("Apila 9 espera false:\t\t\t\t\t" + ((p2.apilar(9) == false) ? sOk : sErr));
    ...
    public static void testPilaDinamica() {

        System.out.println("***************COMIENZO TEST PILA DINAMICA*******************");
        lineales.dinamicas.Pila p1 = new lineales.dinamicas.Pila();
        System.out.println("\t\t\t\t\t\t\t\t--> " + p1.toString());
        ...
        System.out.println("Recupera tope espera 10 recupera " + p1.obtenerTope() + ": \t\t\t" + (((int) p1.obtenerTope() == 10) ? sOk : sErr));
        ...
        lineales.dinamicas.Pila p2 = p1.clone();
        System.out.println("Copia espera 1,2,3,4,5,6,7,8,6: \t\t\t\t--> " + p2.toString());
